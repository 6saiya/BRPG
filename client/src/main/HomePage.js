var Home = (function(_super){
    function Home(enemy, yourAllHero){
        Home.super(this);
        this.init();
        this.show();
        ...
        this.getChildByName('btn_rank').on(Laya.Event.CLICK,this,this.btn_rank);
        this.getChildByName('btn_money').on(Laya.Event.CLICK,this,this.btn_money);
        // this.getChildByName('btn_fight').on(Laya.Event.CLICK,this,this.btn_fight);
        // this.getChildByName('btn_shop').on(Laya.Event.CLICK,this,this.btn_shop);
        this.getChildByName('border').on(Laya.Event.CLICK,this,this.head);
    ...
    _proto.init = function(){
        ...
        this.getChildByName('country').index = user.country;
        ...
        this.getChildByName('head').skin = "headPortrait/"+ user.head + ".png";
        this.getChildByName('chanceHead').visible = false;
        if(user.jiangpai == 16){
            this.getChildByName('jiangpai').visible = false;
        }else{
            this.getChildByName('jiangpai').visible = true;
            this.getChildByName('jiangpai').index = user.jiangpai;
        }
    }
    ...
    _proto.btn_pvp = function(){
        if(LayaSample.pvpPage){
            LayaSample.pvpPage.show();
        }else{
            LayaSample.pvpPage = new PVPPage();
            Laya.stage.addChild(LayaSample.pvpPage);
        }
    }
